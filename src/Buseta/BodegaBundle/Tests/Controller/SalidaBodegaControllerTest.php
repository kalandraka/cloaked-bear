...
class SalidaBodegaControllerTest extends AbstractWebTestCase
{
    ...
    public function testShow()
    {
        ...
        $this->assertEquals(200, $this->client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /bodega/salidabodega/salidabodega\\d+/show");
    ...
    public function testEdit()
    {
        ...
        $this->assertEquals(200, $this->client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /bodega/salidabodega/salidabodega\\d+/edit");
