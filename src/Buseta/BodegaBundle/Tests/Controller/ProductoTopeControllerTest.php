...
class ProductoTopeControllerTest extends AbstractWebTestCase
{
    public function testIndex()
    {
        // Test search/list ProductoTope
        $crawler = $this->client->request('GET', '/bodega/productotope/');
        $this->assertEquals(200, $this->client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /bodega/productotope/");
    ...
    public function testShow()
    {
        ...
        $this->assertEquals(200, $this->client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /bodega/productotope/\\d+/show");
    ...
    public function testEdit()
    {
        ...
        $this->assertEquals(200, $this->client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /bodega/productotope/\\d+/edit");
    ...
    {
        // Test create ProductoTope
        $crawler = $this->client->request('GET', '/bodega/productotope/new');
        $this->assertEquals(200, $this->client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /bodega/productotope/new");
