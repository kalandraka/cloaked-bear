<?php
namespace HatueySoft\NotificacionesBundle\Form\Models;
...
class ConfigNotificacionesCustom {
    ...
    /**
     * @param \HatueySoft\NotificacionesBundle\Entity\ConfigNotificaciones $configNotificacion
     */
    function __construct(\HatueySoft\NotificacionesBundle\Entity\ConfigNotificaciones $configNotificacion = null)
    {
        if($configNotificacion){
            ...
            $this->numerosDefinidos     = $configNotificacion->getNumerosDefinidos();
            ...
            $this->notificacionSMS      = $configNotificacion->getNotificacionSMS();
    ...
    /**
     * @param array $numerosDefinidos
     */
    public function setNumerosDefinidos($numerosDefinidos)
    {
        $this->numerosDefinidos = $numerosDefinidos;
    }

    /**
     * @return array
     */
    public function getNumerosDefinidos()
    {
        return $this->numerosDefinidos;
    }
