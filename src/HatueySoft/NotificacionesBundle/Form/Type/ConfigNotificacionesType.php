...
namespace HatueySoft\NotificacionesBundle\Form\Type;
...
class ConfigNotificacionesType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('numeroSelector','text',array(
                'label'  => 'Números',
                'mapped' => false,
                'required' => false,
            ))
            ->add('numerosDefinidos','collection',array(
                'type' => 'hidden',
                'allow_add'    => true,
                'by_reference' => false,
                'allow_delete' => true,
            ...
            ->add('notificacionSMS','checkbox',array(
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'HatueySoft\NotificacionesBundle\Form\Models\ConfigNotificacionesCustom'
        ));
    }
