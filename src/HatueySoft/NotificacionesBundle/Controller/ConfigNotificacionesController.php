...
use HatueySoft\NotificacionesBundle\Form\Models\ConfigNotificacionesCustom;
...
class ConfigNotificacionesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@HatueySoftNotificaciones/ConfigNotificaciones/index.html.twig', array(
    ...
    public function editAction($codigo)
    {
        ...
        return $this->render('@HatueySoftNotificaciones/ConfigNotificaciones/edit.html.twig',array(
                'defaultNotificacion' => $this->defaultNotificacion,
                'codigo' => $codigo,
                'form' => $form,
            ));
    ...
    public function updateAction($codigo, Request $request)
    {
        ...
        $entity = $this->em->getRepository('HatueySoftNotificacionesBundle:ConfigNotificaciones')->findOneByCodigo($codigo);
    ...
    {
        try{
            $configuraciones = $this->em->getRepository('HatueySoftNotificacionesBundle:ConfigNotificaciones')->findAll();
    ...
    private function loadConfiguracion($codigo)
    {
        try
        {
            $configuracion = $this->em->getRepository('HatueySoftNotificacionesBundle:ConfigNotificaciones')->findOneBy(
                array(
                    'codigo' => $codigo,
                )
            );
