 ...
 * @ORM\Entity(repositoryClass="HatueySoft\NotificacionesBundle\Entity\Repository\ConfigNotificacionesRepository")
 */
class ConfigNotificaciones
{
     ...
     * @var array
     *
     * @ORM\Column(name="numerosDefinidos", type="array", nullable=true)
     */
     ...
     * @var boolean
     *
     * @ORM\Column(name="notificacionSMS", type="boolean", nullable=true)
     */
